...
<div id="discord-card" class="discord-card" data-widget-url="https://discord.com/api/guilds/1405232555443097733/widget.json">
  <div class="discord-card-header">
    <img src="/assets/img/logo.color.notext.svg" alt="Saṁbhāṣaṇa" class="discord-card-logo" />
    <div>
      <div class="discord-card-name">Saṁbhāṣaṇa</div>
      <div class="discord-card-subtitle">Private Group Server</div>
    </div>
  </div>
  <div id="discord-members" class="discord-members">
    <span class="discord-members-loading">Loading members…</span>
  </div>
</div>
